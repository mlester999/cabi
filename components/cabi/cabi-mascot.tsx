  ...
  return (
    ...
    >
      ...
      <g className="cabi-mascot-bob">
        ...
        <path d="M26 22 23 11l10 5z" fill="#f0abfc" opacity="0.4" />
        <path d="M74 22 77 11l-10 5z" fill="#f0abfc" opacity="0.4" />

        <rect x="13" y="19" width="74" height="66" rx="26" fill="url(#cabi-mascot-body)" />
        <rect x="13" y="19" width="74" height="66" rx="26" fill="none" stroke="#ede9fe" strokeOpacity="0.34" strokeWidth="1.4" />
        ...
        <path d="M46.4 63.4h7.2l-3.6 3.2z" fill="#7c3aed" />
        <path d="M50 66.6v2.6" stroke="#7c3aed" strokeWidth="1.5" strokeLinecap="round" fill="none" />
        <path d="M50 69.2c-2.3 0-3.9-1.2-4.6-2.4M50 69.2c2.3 0 3.9-1.2 4.6-2.4" stroke="#7c3aed" strokeWidth="1.5" strokeLinecap="round" fill="none" />

        <g stroke="#f5f3ff" strokeOpacity="0.55" strokeWidth="1.2" strokeLinecap="round">
