...
export function AdminDataTable({ resource, title, description }: { resource: "users" | "conversations" | "memories" | "audit"; title: string; description: string }) {
