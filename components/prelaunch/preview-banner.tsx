...
import { Eye, EyeOff, Gauge, LoaderCircle, LogOut } from "lucide-react";
...
export function PreviewBanner({ mode, actor }: { mode: PreviewChromeMode; actor: { kind: "admin" | "wallet"; label: string } }) {
  ...
  return (
    <div className="sticky top-0 z-[80] shrink-0 border-b border-amber-300/15 bg-[#12100a]/92 backdrop-blur-xl">
      <div className="mx-auto flex min-h-10 w-full max-w-[1400px] flex-wrap items-center gap-x-4 gap-y-1 px-4 py-1.5 sm:px-6">
